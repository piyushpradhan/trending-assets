...
function Card({ currency }: Currency) {
  return (
    <div className="flex flex-col justify-center items-center w-fit">
      ...
      <div
        className="relative w-full h-full flex flex-col space-y-2 justify-center items-center"
        style={{ transform: "scale(0.8) translateY(-1.5rem)" }}
      >
        ...
        <div className="w-full py-2 shadow-valueShadow rounded-2xl flex flex-row bg-valueBg space-x-2 justify-center items-center">
          <p className="text-base text-valueText text-clip">{currency.value}</p>
          <b>
